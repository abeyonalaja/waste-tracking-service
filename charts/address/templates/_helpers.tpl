...
helm.sh/chart: {{ include "address.chart" . }}
{{ include "address.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "address.secretName" -}}
{{- default (include "address.fullname" .) .Values.secret.name }}
{{- end }}
...
*/}}
{{- define "address.env"}}
{{- $secretName := default (include "address.secretName" .) }}
...
*/}}
{{- define "address.secretProviderClassName" -}}
{{- default (include "address.fullname" .) .Values.secretProviderClass.name }}
{{- end }}