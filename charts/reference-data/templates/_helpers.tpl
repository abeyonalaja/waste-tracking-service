...
*/}}
{{- define "reference-data.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "reference-data.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "reference-data.secretName" -}}
{{- default (include "reference-data.fullname" .) .Values.secret.name }}
{{- end }}

{{/*
Create the environment variables to use
*/}}
{{- define "reference-data.env"}}
{{- $secretName := default (include "reference-data.secretName" .) }}
