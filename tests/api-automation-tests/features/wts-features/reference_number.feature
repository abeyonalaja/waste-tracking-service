...
Feature: AS A Waste Producer/Broker
  ...
  Scenario: Check the waste reference number valid
    Given I POST reference number "testing" for waste export
  ...
  Scenario: Check the waste reference number limit more than 50 characters
    Given I POST reference number "abcdefghijklmnopqrstuvwxy987234987293847923479234983z01234567891234567890dfghujgdfd" for waste export
