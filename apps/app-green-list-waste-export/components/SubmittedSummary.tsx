...
export const SubmittedSummary = ({
  ...
  const quantityType = () => {
    if (data.wasteDescription.wasteCode.type !== 'NotApplicable') {
      if (data.wasteQuantity?.type === 'EstimateData') {
        return data.wasteQuantity.estimateData.quantityType;
      } else {
        if (data.wasteQuantity?.type === 'ActualData') {
          return data.wasteQuantity.actualData.quantityType;
        }
      }
    }
  };
    ...
    <div data-testid={testId}>
      ...
      >
        ...
        <AccordionSection
          ...
          showTag={data.wasteQuantity.type === 'EstimateData' && estimate}
        >
          {
            <>
              <DefinitionList>
                    ...
                    <Row>
                      ...
                      {data.wasteQuantity && (
                        <Value id="waste-quanitity">
                          ...
                          {data.wasteQuantity?.type === 'EstimateData' && (
                            <span>{data.wasteQuantity.estimateData.value}</span>
                          )}
                          {data.wasteQuantity?.type === 'ActualData' && (
                            <span>{data.wasteQuantity.actualData.value}</span>
                          )}
        ...
        <AccordionSection
          ...
          showTag={data.collectionDate.type === 'EstimateDate' && estimate}
        >
          {
            <>
              <DefinitionList>
                <Row>
                  ...
                  {data.collectionDate.type === 'EstimateDate' && (
                ...
                <Row>
                  ...
                  <Value id="exit-location">
                    {data.ukExitLocation?.provided === 'Yes' && (
                      <span>{data.ukExitLocation?.value}</span>
                    )}
                    {data.ukExitLocation?.provided === 'No' && (
