 ...
 */
export class ReferenceDataStub implements ReferenceDataBackend {
  wasteCodes: api.WasteCodeType[] = [
    {
      type: 'BaselAnnexIX',
      values: [
        {
  ...
  recoveryCodes: api.RecoveryCode[] = [
    {
      code: 'R1',
      value: {
        description: {
