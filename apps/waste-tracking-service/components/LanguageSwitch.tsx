...
export const LanguageSwitch = ({ showAll = false }: Props) => {
        ...
        {isWelshActive && (
          <LanguageList>
            <LanguageListItem>
              ...
              >
                <VisuallyHidden>{t('language.languageMessage')}</VisuallyHidden>
            ...
            <LanguageListItemCurrent>
              <span aria-hidden="true">{t('language.languageLinkWelsh')}</span>
            </LanguageListItemCurrent>
          </LanguageList>
        )}
        {isEnglishActive && (
