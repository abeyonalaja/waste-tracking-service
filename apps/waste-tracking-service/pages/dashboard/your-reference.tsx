      ...
      <Main>
        <GridRow>
          <GridCol setWidth="two-thirds">
            ...
            <HintText>{t('yourReference.description')}</HintText>

            <div>
              <FormGroup>
                <Radio name="group1">{t('radio.yes')}</Radio>
                ...
                <Radio name="group1">{t('radio.no')}</Radio>
              </FormGroup>
              <FormGroup>
                <Button>{t('yourReference.button')}</Button>
              </FormGroup>
            </div>
          </GridCol>
