  ...
  const handleSubmit = useCallback(
    (e: FormEvent, form, returnToDraft = false) => {
      ...
      if (isNotEmpty(newErrors)) {
        ...
        try {
          fetch(
            `${process.env.NX_API_GATEWAY_URL}/templates/${templateId}/recovery-facility/${interimPage.facilityData.id}`,
            {
              method: 'PUT',
              headers: {
            ...
            .then((data) => {
              if (data !== undefined) {
                ...
                if (returnToDraft) {
                  ...
                  router.push({
                    pathname: `/export/templates/treatment/recovery-facility-details`,
                    query: { templateId },
                  });
                } else {
                  dispatchInterimPage({
