...
const TemplateCopy = ({ apiConfig }: PageProps) => {
                ...
                {templatePage.showView === VIEWS.DEFAULT && (
                  <>
                    <GovUK.Caption size="L">
                      {t('templates.copy.caption')}:{' '}
                      {templatePage.data.templateDetails.name}
                    </GovUK.Caption>
                    <GovUK.Heading size="L">
                      {t('templates.copy.title')}
                    </GovUK.Heading>
                    <Paragraph>{t('templates.copy.intro')}</Paragraph>
