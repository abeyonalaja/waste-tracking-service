...
const UploadButton = styled(GovUK.Button)`
  margin-top: 20px;
`;
      ...
      >
        ...
        <GovUK.GridRow mb={6}>
          <GovUK.GridCol setWidth="two-thirds">
            <GovUK.H2 size="MEDIUM">
              {t('multiples.guidance.listHeading')}
            </GovUK.H2>
            <GovUK.OrderedList>
              <GovUK.ListItem>
              ...
              <GovUK.ListItem>
                {t('multiples.guidance.listItemFour')}
              </GovUK.ListItem>
              <GovUK.ListItem>
                {t('multiples.guidance.listItemFive')}
              </GovUK.ListItem>
            </GovUK.OrderedList>
          </GovUK.GridCol>
        </GovUK.GridRow>
        ...
        <GovUK.GridRow mb={6}>
          <GovUK.GridCol setWidth="two-thirds">
            ...
            <GovUK.FormGroup>
              <GovUK.FileUpload name={t('multiples.guidance.upload.button')}>
                <GovUK.H2 size="MEDIUM">
                  {t('multiples.guidance.upload.heading')}
                </GovUK.H2>
                <GovUK.Caption size="MEDIUM">
                  {t('multiples.guidance.upload.sub')}
                </GovUK.Caption>
              </GovUK.FileUpload>
