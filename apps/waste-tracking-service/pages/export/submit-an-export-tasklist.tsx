    ...
    return (
      <BreadcrumbWrap>
        <GovUK.Breadcrumbs>
          ...
          <GovUK.Breadcrumbs.Link href={process.env.NX_EXPORT_URL}>
            {t('app.title')}
          </GovUK.Breadcrumbs.Link>
          <GovUK.Breadcrumbs.Link
            href={`${process.env.NX_EXPORT_URL}/add-your-own-export-reference?id=${id}`}
          >
                ...
                <TaskListItems>
                  <TaskListItem>
                    <TaskName>
                      <AppLink
                        href={{
                          pathname: `${process.env.NX_EXPORT_URL}/waste-code`,
                          query: { id },
                        }}
                      >
                        {t(
                        ...
                        href={{
                          pathname:
                            ...
                            tasklistPage.data?.exporterDetail.status ===
                              ...
                              : `${process.env.NX_EXPORT_URL}/exporter-postcode`,
                          query: { id, dashboard: true },
                        }}
                        id="exporter-details"
                      >
                        ...
                        href={{
                          pathname:
                            tasklistPage.data?.carriers.status === 'Complete'
                              ? `${process.env.NX_EXPORT_URL}/waste-carriers`
                              : `${process.env.NX_EXPORT_URL}/waste-carrier-details`,
                          query: { id },
                        }}
                        id="waste-carriers"
                      >
                    ...
                    <TaskName>
                      ...
                      {(tasklistPage.data?.wasteDescription.status ===
                        ...
                        'NotApplicable' ? (
                          <AppLink
                            href={{
                              pathname: `${process.env.NX_EXPORT_URL}/laboratory-details`,
                              query: { id, dashboard: true },
                            }}
                          >
                            {t(
                          ...
                          <AppLink
                            href={{
                              pathname: `${process.env.NX_EXPORT_URL}/interim-site`,
                              query: { id, dashboard: true },
                            }}
                          >
                            {t(
                  ...
                  <TaskListItem>
                    <TaskName>
                      ...
                      'CannotStart' ? (
                        <AppLink
                          href={{
                            pathname: `${process.env.NX_EXPORT_URL}/check-your-report`,
                            query: { id, dashboard: true },
                          }}
                        >
                          {t(
                  ...
                  <TaskListItem>
                    <TaskName>
                      ...
                      'CannotStart' ? (
                        <AppLink
                          href={{
                            pathname: `${process.env.NX_EXPORT_URL}/sign-declaration`,
                            query: { id, dashboard: true },
                          }}
                        >
                          {t(
