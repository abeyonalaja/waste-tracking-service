...
import { contentProcessingTask, contentToBeProcessedTask } from './task-schema';
...
describe('contentToBeProcessedTask', () => {
  ...
  it('is compatible with dto values', () => {
    const value: ContentToBeProcessedTask = {
      ...
      type: 'service-green-list-waste-export-bulk.event.sent.ContentToBeProcessed',
      source: 'service-green-list-waste-export-bulk.addContentToBatch',
      specversion: '1.0',
      datacontenttype: 'application/cloudevents+json',
      pubsubname: 'SNDWTSINFASB1401.servicebus.windows.net',
      queue: 'service-green-list-waste-export-bulk-tasks',
