...
): ValidationResult<'EstimateData' | 'ActualData'> {
    ...
    return {
      ...
      errors: {
        fieldFormatErrors: [
          {
            field: 'WasteQuantity',
            message: errorMessages.missingWasteQuantityType[locale][context],
          },
        ],
      },
    };
...
export function validateCollectionDate(
  ...
  const result = commonValidationRules.validateCollectionDate(
    day,
    month,
    year,
    futureDatesOnly,
      ...
      switch (error) {
        case 'empty':
          errors.push({
            ...
            message: commonErrorMessages.emptyCollectionDate[locale][context],
          });
          break;
        ...
        case 'invalid':
          errors.push({
            field: 'CollectionDate',
            message: commonErrorMessages.invalidCollectionDate[locale][context],
          });
          break;
      }
    }
    ...
    return {
      ...
      errors: {
        fieldFormatErrors: [
          {
            field: 'CollectionDate',
            message: errorMessages.missingTypeCollectionDate[locale][context],
          },
        ],
      },
    };
