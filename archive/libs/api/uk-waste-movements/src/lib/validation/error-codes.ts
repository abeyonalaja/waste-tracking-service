...
export const wasteCollectionEmptyAddressLine1 = 12003;
export const wasteCollectionCharTooManyAddressLine1 = 12004;
export const wasteCollectionCharTooManyAddressLine2 = 12005;
export const wasteCollectionEmptyTownOrCity = 12006;
export const wasteCollectionCharTooManyTownOrCity = 12007;
export const wasteCollectionEmptyCountry = 12008;
export const wasteCollectionInvalidCountry = 12009;
export const wasteCollectionInvalidPostcode = 12010;
export const wasteCollectionMissingWasteSource = 12011;
export const wasteCollectionInvalidWasteSource = 12012;
export const wasteCollectionCharTooManyBrokerRegistrationNumber = 12013;
export const wasteCollectionCharTooManyCarrierRegistrationNumber = 12014;
