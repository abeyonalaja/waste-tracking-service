...
module GeneralHelpers
  ...
  SAVE_AND_RETURN_TO_DRAFT ||= Translations.value 'saveReturnButton'
  SAVE_AND_RETURN ||= Translations.value 'single.postcode.buttonSecondary'
  ...
  USE_THIS_BUTTON_AND_CONTINUE  ||=Translations.ukmv_value 'single.postcode.useAddress'
  ...
  def save_and_return_to_draft
    click_link SAVE_AND_RETURN_TO_DRAFT
  end

  def save_and_return
    click_button SAVE_AND_RETURN
  end
  ...
  def use_this_button_and_continue
    click_on USE_THIS_BUTTON_AND_CONTINUE
  end
