...
class WhatsCarrierAddressPage < GenericPage
  include CommonComponents
  include GeneralHelpers
  include ErrorBox
  include PageHelper

  TITLE = Translations.ukmv_value 'single.carrierAddress.postcode.search.heading'
  CAPTION = Translations.ukmv_value 'single.carrierAddress.caption'
  INTRO = Translations.ukmv_value 'single.carrierAddress.postcode.search.intro'
