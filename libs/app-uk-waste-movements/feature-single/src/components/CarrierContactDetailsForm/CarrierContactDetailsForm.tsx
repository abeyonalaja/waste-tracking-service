...
interface CarrierContactDetailsFormProps {
  id: string;
...
export function CarrierContactDetailsForm({
  id,
  initialFormState,
  token,
  formStrings,
  ...
  async function handleSubmit(
    ...
    try {
      response = await fetch(
        `${process.env.NEXT_PUBLIC_API_GATEWAY_URL}/ukwm/drafts/${id}/carrier-contact?saveAsDraft=${submitType === 'returnToTaskList'}`,
        {
          method: 'PUT',
          headers: {
